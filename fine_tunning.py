...
print("="*60)
print("\nBASIC MODE (Maximum compatibility - Recommended):")
print("   start_training_basic_mode()")
print("   → Uses standard Trainer, works with any TRL version")

print("\n2️⃣ SMALL MODEL MODE (Memory efficient):")
print("   start_training_small_model()")
print("   → DialoGPT-small with adaptive LoRA")

print("\n3️⃣ UPLOAD FILE (Original model):")
print("   start_training_with_upload()")
print("   → Auto-adapts to any model, smart error handling")

print("\n4️⃣ CPU-ONLY MODE (If GPU fails):")
...
print("\n⚡ TRAINER COMPATIBILITY FEATURES:")
